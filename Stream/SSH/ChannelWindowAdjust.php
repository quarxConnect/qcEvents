<?PHP
  ...
  /**
   * qcEvents - SSH Channel Window Adjust Message
  ...
  class qcEvents_Stream_SSH_ChannelWindowAdjust extends qcEvents_Stream_SSH_Message {
    const MESSAGE_TYPE = 93;
    
    /* Number of channel on sender-side */
    public $RecipientChannel = 0x00000000;
    
    /* Number of bytes to add to the window */
    public $bytesToAdd = 0x00000000;
    ...
    public function unpack ($Packet) {
      ...
      if ((($RecipientChannel = self::readUInt32 ($Packet, $Offset, $Length)) === null) ||
          (($bytesToAdd = self::readUInt32 ($Packet, $Offset, $Length)) === null) ||
          ($Offset != $Length))
        return false;
    ...
    public function pack () {
      return
        ...
        self::writeUInt32 ($this->bytesToAdd);
    }
    // }}}
  }

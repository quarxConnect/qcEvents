<?PHP
  ...
  /**
   * qcEvents - SSH Unimplemented Message
  ...
  class qcEvents_Stream_SSH_Unimplemented extends qcEvents_Stream_SSH_Message {
    ...
    public function unpack ($Packet) {
      ...
      if (($Sequence = self::readUInt32 ($Packet, $Offset, $Length)) === null)
        return false;
    ...
    public function pack () {
      return self::writeUInt32 ($this->Sequence);
    }
    // }}}
  }

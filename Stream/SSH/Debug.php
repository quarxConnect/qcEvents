<?PHP
  ...
  class qcEvents_Stream_SSH_Debug extends qcEvents_Stream_SSH_Message {
    ...
    public function unpack ($Packet) {
      ...
      if ((($Display = self::readBoolean ($Packet, $Offset, $Length)) === null) ||
          (($Message = self::readString ($Packet, $Offset, $Length)) === null) ||
    ...
    public function pack () {
      return
        self::writeBoolean ($this->Display) .

<?PHP
  ...
  /**
   * qcEvents - DNS Nameserver Resource Record
  ...
  class qcEvents_Stream_DNS_Record_NS extends qcEvents_Stream_DNS_Record {
    const DEFAULT_TYPE = 0x02;
     ...
     **/
    function __toString () {
      return $this->getLabel () . ' ' . $this->getTTL () . ' ' . $this->getClassName () . ' NS ' . $this->Hostname;
    }
    // }}}

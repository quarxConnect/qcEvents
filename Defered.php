<?PHP
  ...
  class qcEvents_Defered {
    ...
    function __construct ($BaseOrPromise = null, callable $Resolve = null, callable $Reject = null) {
      ...
      if ($BaseOrPromise instanceof qcEvents_Promise) {
      ...
      } elseif (($BaseOrPromise === null) || ($BaseOrPromise instanceof qcEvents_Base))
        // Create a new promise
        $this->Promise = new qcEvents_Promise (

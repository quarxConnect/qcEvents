<?php
  ...
  class Message {
     ...
     **/
    public const OPCODE_QUERY  = 0x00;
    public const OPCODE_IQUERY = 0x01; // Obsoleted by RFC 3425
     ...
     **/
    public const ERROR_NONE          = 0x00;
    public const ERROR_FORMAT        = 0x01;
    public const ERROR_SERVER        = 0x02;
    public const ERROR_NAME          = 0x03; # TODO: Remove this
    public const ERROR_NXDOMAIN      = 0x03;
    public const ERROR_UNSUP         = 0x04;
    public const ERROR_REFUSED       = 0x05;
    public const ERROR_YXDOMAIN      = 0x06; // RFC 2136 Update
    public const ERROR_YXRRSET       = 0x07; // RFC 2136 Update
     ...
     **/
    public const FLAG_AUTHORITATIVE       = 0x01;
     ...
     **/
    public const CLASS_INTERNET = 0x0001;
    public const CLASS_CHAOS    = 0x0003;
     ...
     **/
    public const TYPE_A      = 0x01;	// RFC 1035
    public const TYPE_NS     = 0x02;	// RFC 1035
    public const TYPE_MD     = 0x03;	// RFC 1035, Obsoleted
    public const TYPE_MF     = 0x04;	// RFC 1035, Obsoleted
    public const TYPE_CNAME  = 0x05;	// RFC 1035
    public const TYPE_SOA    = 0x06;	// RFC 1035
    public const TYPE_MB     = 0x07;	// RFC 1035, Experimental
    public const TYPE_MG     = 0x08;	// RFC 1035, Experimental
    public const TYPE_MR     = 0x09;	// RFC 1035, Experimental
    public const TYPE_NULL   = 0x0A;	// RFC 1035, Experimental
    public const TYPE_WKS    = 0x0B;	// RFC 1035
    public const TYPE_PTR    = 0x0C;	// RFC 1035
    public const TYPE_HINFO  = 0x0D;	// RFC 1035
    public const TYPE_MINFO  = 0x0E;	// RFC 1035
    public const TYPE_MX     = 0x0F;	// RFC 1035
    public const TYPE_TXT    = 0x10;	// RFC 1035
    public const TYPE_RP     = 0x11;	// RFC 1183
    public const TYPE_AAAA   = 0x1C;	// RFC 3596

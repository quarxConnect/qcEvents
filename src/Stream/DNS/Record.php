<?php
  ...
  class Record {
     ...
     **/
    private $Type = Message::TYPE_ANY;
    
    /**
     * [QClass] Class of this DNS-RR
     **/
    private $Class = Message::CLASS_INTERNET;
     ...
     **/
    public static function fromString (&$dnsData, &$dataOffset, $dataLength = null) : Record {
    ...
    public function parsePayload (&$dnsData, &$dataOffset, $dataLength = null) {
      ...
      switch ($this->Type) {
        ...
        // Hostnames
        case Message::TYPE_MB:
        case Message::TYPE_MD:
        case Message::TYPE_MF:
        case Message::TYPE_MG:
        case Message::TYPE_MR:
          $this->Hostname = Message::getLabel ($dnsData, $dataOffset);
          break;
        
        // Two hostnames
        case Message::TYPE_MINFO:
          #$this->Mailbox = Message::getLabel ($dnsData, $dataOffset);
          #$this->errorMailbox = Message::getLabel ($dnsData, $dataOffset);
          
          #break;
        
        // Specials
        case Message::TYPE_HINFO:

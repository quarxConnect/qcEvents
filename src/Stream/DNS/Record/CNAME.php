<?php
  ...
  /**
   * quarxConnect Events - DNS CNAME Resource Record
  ...
  class CNAME extends DNS\Record {
    protected const DEFAULT_TYPE = 0x05;
    ...
    public function buildPayload ($Offset, &$Labels) {
      ...
      return Message::setLabel ($this->destinationHost, $Offset, $Labels);
    }
    // }}}
  }

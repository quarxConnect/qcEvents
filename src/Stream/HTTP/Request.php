<?php
  ...
  class Request extends Events\Stream\HTTP {
    ...
    private static $preferredAuthenticationMethods = [
      'Digest',
      'Basic'
    ];
    ...
    public function toString (bool $humanReadable = false): string {
      // Make sure that files and values are transferred properly
    ...
    // {{{ getHostname
    /**
     * Retrieve the hostname for this request
     *
     * @access public
     * @return string
     **/
    public function getHostname (): ?string {
      // Retrieve the hostname from headers
    ...
    // {{{ getPort
    /**
     * Retrieve the port for this request
     *
     * @access public
     * @return int
     **/
    ...
    // {{{ useTLS
    /**
     * Check whether to use TLS for this request
     *
     * @access public
     * @return bool
     **/
     ...
     *
     * @param string|array $requestURL
     *
     * @access public
     * @return void
     **/
    public function setURL (string|array $requestURL): void
    {
    ...
    // {{{ getUsername
    /**
     * Retrieve a username assigned to this request
     *
     * @access public
     * @return string
     **/
    ...
    // {{{ getPassword
    /**
     * Retrieve a password assigned to this request
     * 
     * @access public
     * @return string
     **/
    ...
    private function applyCredentials (): void {
      // Check whether to remove an authentication-information
      if (
        ($this->authUsername === null) &&
        ($this->authPassword === null)
      ) {
      ...
      // Try supported authentication-methods in preferred order
      foreach ($this::$preferredAuthenticationMethods as $authMethod)
    ...
    public function setBody (string $requestBody = null, string $mimeType = null): void {
      // Check whether to remove the body from request
      if ($requestBody === null) {
    ...
    // {{{ getMaxRedirects
    /**
     * Retrieve the maximum number of redirects
     *
     * @access public
     * @return int
     **/
     ...
     * @return void
     **/
    public function attachValue (string $valueName, string $valueData, string $mimeType = null): void
    {
     ...
     * @param string|null $fileTitle (optional) Name of the file
     * @param string|null $fileName (optional) Filename to send to the server
     * @param string|null $mimeType (optional) MIME-Type to send to the server
     *
     * @return void
     **/
    ...
    // {{{ httpFailed
    /**
     * Internal Callback: Single HTTP-Request/Response was not finished properly
     *

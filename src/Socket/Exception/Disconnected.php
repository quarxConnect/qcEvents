<?php
  ...
  /**
   * quarxConnect Events - Exception when a socket was disconnected
   *
  ...
  class Disconnected extends RuntimeException {
    // {{{ __construct
    /**
     ...
     * @return void
     **/
    public function __construct (string $errorMessage = 'Socket was closed') {

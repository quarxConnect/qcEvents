<?PHP
  ...
  class qcEvents_Socket_Stream_DNS_Record {
     ...
     **/
    private $Type = qcEvents_Socket_Stream_DNS_Message::TYPE_ANY;
    
    /**
     * [QClass] Class of DNS-RRs that is asked for
     **/
    private $Class = qcEvents_Socket_Stream_DNS_Message::CLASS_INTERNET;
    ...
    public function parse ($Data, &$Offset) {
      ...
      switch ($this->Type) {
        // IPv4-Addresses
        case qcEvents_Socket_Stream_DNS_Message::TYPE_WKS:
        ...
        case qcEvents_Socket_Stream_DNS_Message::TYPE_MB:
        case qcEvents_Socket_Stream_DNS_Message::TYPE_MD:
        case qcEvents_Socket_Stream_DNS_Message::TYPE_MF:
        case qcEvents_Socket_Stream_DNS_Message::TYPE_MG:
        case qcEvents_Socket_Stream_DNS_Message::TYPE_MR:
        case qcEvents_Socket_Stream_DNS_Message::TYPE_NS:
        case qcEvents_Socket_Stream_DNS_Message::TYPE_PTR:
          $this->Hostname = qcEvents_Socket_Stream_DNS_Message::getLabel ($Data, $pOffset);
          break;
        ...
        // Start-of-Authority
        case qcEvents_Socket_Stream_DNS_Message::TYPE_SOA:
          #$PrimaryNS = qcEvents_Socket_Stream_DNS_Message::getLabel ($Data, $pOffset);
          #$Mailbox = qcEvents_Socket_Stream_DNS_Message::getLabel ($Data, $pOffset);
        ...
        // Two hostnames
        case qcEvents_Socket_Stream_DNS_Message::TYPE_MINFO:
          #$this->Mailbox = qcEvents_Socket_Stream_DNS_Message::getLabel ($Data, $pOffset);
          #$this->errorMailbox = qcEvents_Socket_Stream_DNS_Message::getLabel ($Data, $pOffset);
          
          #break;
        
        // Specials
        case qcEvents_Socket_Stream_DNS_Message::TYPE_HINFO:
          // CPU / OS Character-Strings
        
        case qcEvents_Socket_Stream_DNS_Message::TYPE_TXT:
        case qcEvents_Socket_Stream_DNS_Message::TYPE_NULL:
          break;
      }
